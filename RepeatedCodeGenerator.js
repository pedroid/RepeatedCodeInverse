...
function analyze(){
        ...
        //�ˬd�̫��@���O�_�Omultiple spaces�A�p�G�O���ܡApop()
    ...
    */
    ...
    RulesOfVar_data = [];// [0]: �Ĥ@���ܼƪ��W�h; [1]�G�ĤG���ܼƪ��W�h
    ...
    for(var index=0;index<NumVar; index++){//�Y���Ʀr���Ƭ�random�A�ŧi���ܼƧǦC
